...
public class RechargePasswordActivity extends BaseActivity implements PayPasswordEditText.OnEntryCompleteListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recharge_password);
    ...
    public void onEntryComplete(String password) {
        startActivity(new Intent(context, RechargeSucceedActivity.class));
        finish();
    }
}
