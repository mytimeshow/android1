...
public class MessageDialog extends BaseDialogFragment {
    ...
    public MessageDialog setNegativeButton(String negative) {
        mNegative = negative;
        return this;
    }

    public MessageDialog setPositiveButton(String positive) {
        mPositive = positive;
        return this;
    }

    public MessageDialog setOnClickListener(OnClickListener listener) {
        mListener = listener;
        return this;
    }
    ...
    public interface OnClickListener {
        void onClick(MessageDialog dialog, int what);
    }
}
